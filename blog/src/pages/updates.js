          ...
          return (
            ...
            >
              <header className="update-item-header">
                <time className="update-item-date">{update.frontmatter.date}</time>
                <br />
                <h2 className="update-item-title">
                  <Link to={update.fields.slug} itemProp="url">
                    <span itemProp="headline">{title}</span>
                  </Link>
                </h2>
              </header>
              <section className="update-item-content">
                <p itemProp="description">
                  {update.frontmatter.description || update.excerpt}
                </p>
              </section>
            </article>
          )
...
export const Head = () => <Seo title="Midspiral Blog" />
